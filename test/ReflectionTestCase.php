...
namespace Cspray\CodeAnvil\Test;

use Cspray\CodeAnvil\Test\Constraints\{
    MethodHasDocComment,
    PropertyHasDocComment,
    TypeConstantHasValue,
    TypeHasConstant,
    TypeHasDocComment,
    TypeHasMethod,
    TypeHasNamespace,
    ...
    MethodIsFinal,
    MethodIsStatic,
    MethodParameterHasDefaultValue,
    MethodParameterHasTypeDeclaration,
    MethodParameterIsByReference,
    MethodParameterIsPresent,
    MethodParameterIsRequired,
    MethodParameterIsVariadic,
